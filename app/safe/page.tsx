...
=======
	...
	"function confirmTx(uint256 id)",
	"function executeTx(uint256 id)",
>>>>>>> 818229580d4a4976af2defeb0450d8732d075deb
];
...
=======
	...
	async function createSafe() {
		...
		try {
			...
			const ownersArg: [string, string, string] = [o1, o2, o3];

			let predicted: string | null = null;
			try {
				predicted = await factory.createSave.staticCall(ownersArg);
				predicted = normAddr(predicted ?? "") || null;
			} catch {}

			const tx = await factory.createSave(ownersArg);
			const rc = await tx.wait();
	...
	const pageRootStyle: CSSProperties = { minHeight: "100dvh", display: "flex", flexDirection: "column" };
	const modalBodyStyle: CSSProperties = { padding: 2 };
	const labelTopStyle: CSSProperties = { fontSize: 12, marginTop: 10, textTransform: "uppercase" };
	const labelStyle: CSSProperties = { fontSize: 12, textTransform: "uppercase" };
	const rowSplitTopStyle: CSSProperties = { justifyContent: "space-between", marginTop: 12 };
	const labelSmStyle: CSSProperties = { fontSize: 12 };
	const labelName0Style: CSSProperties = { fontSize: 12, marginTop: 10 };
	const rowEndTopStyle: CSSProperties = { justifyContent: "flex-end", marginTop: 12 };
	const labelName2Style: CSSProperties = { fontSize: 12, marginTop: 2 };
	...
	const headerRightStyle: CSSProperties = { display: "flex", alignItems: "center", gap: 10 };
	const mainStyle: CSSProperties = { flex: "1 1 auto" };
	const containerStyle: CSSProperties = { maxWidth: 1320, width: "100%" };
	const rowMt10Style: CSSProperties = { marginTop: 10 };
	const mainFlexStyle: CSSProperties = { display: "flex", gap: 18, alignItems: "stretch" };
	...
	const rowSplitCenterStyle: CSSProperties = { justifyContent: "space-between", alignItems: "center" };
	const h2SafesStyle: CSSProperties = { margin: 0, fontSize: 22, textTransform: "uppercase" };
	...
	const relStyle: CSSProperties = { position: "relative" };
	const minW0Style: CSSProperties = { minWidth: 0 };
	const safeNameRowStyle: CSSProperties = {
		fontWeight: 780,
		overflow: "hidden",
		textOverflow: "ellipsis",
		whiteSpace: "nowrap",
	...
	const op98Style: CSSProperties = { opacity: 0.98 };
	const mutedShortStyle: CSSProperties = { fontSize: 12, fontWeight: 600 };
	const rowCreateStyle: CSSProperties = { justifyContent: "space-between", marginTop: 6, gap: 8 };
	const showHiddenBtnStyle: CSSProperties = { opacity: showHidden ? 1 : 0.6 };
	const spacer14Style: CSSProperties = { height: 14 };
	const rightPaneStyle: CSSProperties = { flex: "1 1 auto", minWidth: 0 };
	const rowSplitStartStyle: CSSProperties = { justifyContent: "space-between", alignItems: "flex-start" };
	const titleRowStyle: CSSProperties = { display: "flex", alignItems: "baseline", gap: 10, minWidth: 0 };
	const h2SafeStyle: CSSProperties = { margin: 0, fontSize: 22, flex: "0 0 auto", textTransform: "uppercase" };
	const safeTitleStyle: CSSProperties = {
		fontSize: 22,
		fontWeight: 820,
		maxWidth: "min(620px, 100%)",
		overflow: "hidden",
	...
	const safeMetaStyle: CSSProperties = {
		marginTop: 10,
		display: "flex",
		alignItems: "center",
		gap: 10,
	...
	const uppercaseStyle: CSSProperties = { textTransform: "uppercase" };
	const safeErrStyle: CSSProperties = { marginTop: 10, fontSize: 13 };
	const rowBadgeStyle: CSSProperties = { gap: 10, alignItems: "center" };
	const balanceWrapStyle: CSSProperties = { marginTop: 20 };
	const balanceStyle: CSSProperties = { fontSize: 24, fontWeight: 780 };
	const ownersHeaderStyle: CSSProperties = {
		display: "flex",
		marginTop: 16,
		alignItems: "flex-start",
		justifyContent: "space-between",
	};
	const ownersSummaryStyle: CSSProperties = { cursor: "pointer", userSelect: "none", textTransform: "uppercase" };
	const ownersListStyle: CSSProperties = { marginTop: 12 };
	const ownerRowStyle: CSSProperties = { userSelect: "none" };
	const cardsRowStyle: CSSProperties = { display: "flex", gap: 18, flexWrap: "wrap", alignItems: "stretch" };
	const txCardStyle: CSSProperties = { flex: "1 1 520px", minWidth: 0 };
	const txHeaderStyle: CSSProperties = { fontSize: 14, marginBottom: 14, textTransform: "uppercase" };
	const txScrollStyle: CSSProperties = { maxHeight: 520, overflow: "auto", paddingRight: 4 };
	const txColStyle: CSSProperties = { minWidth: 0, display: "flex", flexDirection: "column", gap: 12 };
	const txTitleStyle: CSSProperties = { fontWeight: 780, fontSize: 15, display: "flex", alignItems: "center", gap: 8 };
	const txStatusIconStyle: CSSProperties = { display: "inline-flex", alignItems: "center" };
	const txStatusTextStyle: CSSProperties = { fontWeight: 600, textTransform: "uppercase" };
	const txAmountStyle: CSSProperties = { fontSize: 14 };
	const txSigStyle: CSSProperties = { fontSize: 13, textTransform: "uppercase" };
	const rowWrap8Style: CSSProperties = { gap: 8, flexWrap: "wrap" };
	const rowActions8Style: CSSProperties = { gap: 8, flex: "0 0 auto" };
	const txExplorerWrapStyle: CSSProperties = { display: "flex", justifyContent: "flex-end", marginTop: 12 };
	const txExplorerLinkStyle: CSSProperties = { textDecoration: "none", fontSize: 11 };
	const footerStyle: CSSProperties = { marginTop: "auto" };
	...
	const footerRightStyle: CSSProperties = { display: "flex", alignItems: "center", gap: 14 };

	return (
		<div className={styles.wrap} style={pageRootStyle}>
			<WalletConnectModal
				open={walletModalOpen}
				onClose={() => setWalletModalOpen(false)}
				onSelect={async (eth: any, key: string) => {
			...
			<PortalModal
				...
				showClose={false}
			>
				<div className="stackSm" style={modalBodyStyle}>
					<div className="muted" style={labelTopStyle}>
						Recipient
					</div>
					<input
						placeholder="0x..."
